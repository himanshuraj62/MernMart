...
const CategoryWiseProductDisplay = ({id,name}) => {
  ...
  return (
      <div>
        <div className='container w-full mx-auto p-4 flex items-center justify-between gap-4'>
            <h3 className='font-neutral text-lg md:text-xl'>{name}</h3>
            <Link to={redirectURL}  className='text-green-600 hover:text-green-400'>See all</Link>
        </div> 
          <div className='relative flex items-center '>
             <div className= 'flex   gap-4 md:gap-6 lg:gap-8 container mx-auto px-4 overflow-hidden scrollbar-none scroll-smooth'ref={containerRef}>
            { loading &&
