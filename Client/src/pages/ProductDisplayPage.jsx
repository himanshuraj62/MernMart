...
import image3 from '../assets/logo_circle.png'
...
const ProductDisplayPage = () => {
  ...
  const isRightEmpty = !data.name && !data.unit && !data.price && !data.discount && !data.stock

  return (
    <section
      className={`container mx-auto p-4 ${
        isRightEmpty ? "grid lg:grid-cols-1" : "grid lg:grid-cols-2"
      }`}
    >
      {/* Left Column */}
      <div>
      ...
      {!isRightEmpty && (
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <div className='flex items-center gap-2 lg:gap-4'>
              <div className='border border-green-600 px-4 py-2 rounded bg-green-50 w-fit'>
                <p className='font-semibold text-lg lg:text-xl'>
                  {DisplayPriceInRupees(pricewithDiscount(data.price))}
                </p>
              </div>
              {data.discount && (
          ...
          <h2 className='font-semibold'>Why shop from MernMart?</h2>
          <div>
            ...
            <div className='flex items-center gap-4 my-4'>
              <img src={image3} alt='Wide Assortment' className='w-20 h-20 rounded-full' />
              <div className='text-sm'>
