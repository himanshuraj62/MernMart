  ...
  return (
    <section className='sticky top-24 lg:top-20'>
      <div className='container sticky top-24  mx-auto grid grid-cols-[90px,1fr]  md:grid-cols-[200px,1fr] lg:grid-cols-[280px,1fr]'>
        {/**sub category **/}
        <div className=' min-h-[76vh] max-h-[88vh] overflow-y-scroll  grid gap-1 shadow-md scrollbarCustom bg-white py-2'>
           {
        ...
        <div className='sticky top-20'>
          ...
          <div>
           ...
           <div className='min-h-[65h] max-h-[70vh] overflow-y-auto relative scrollbarCustom'>
